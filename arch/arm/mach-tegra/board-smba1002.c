...
EXPORT_SYMBOL_GPL(smba1002_3g_gps_poweron);

void smba1002_3g_gps_poweroff(void)
{
...
EXPORT_SYMBOL_GPL(smba1002_3g_gps_poweroff);

static atomic_t smba1002_3g_gps_inited = ATOMIC_INIT(0);
void smba1002_3g_gps_init(void)
{
...
void smba1002_3g_gps_deinit(void)
{
